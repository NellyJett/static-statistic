...
const AdminSta = () => {
    return(
        <div className="bg-white rounded-[19.88px] px-[27px] pt-[45px] w-full">
    
            <div className="grid grid-cols-1 gap-[45px] w-full mx-auto sm:grid-cols-3 relative ">
            ...
            <div className="grid grid-cols-1 gap-[45px] w-full mx-auto sm:grid-cols-3 mt-8 pb-6"> 
